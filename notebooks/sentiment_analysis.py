...
if __name__ == "__main__":
    df = pd.read_csv("D:\\New folder (5)\\infosys\\AI_TransferIQ\\data\\transferiq_dataset.csv")
    df_with_sentiment = run_vader_analysis(df)
    df_with_sentiment.to_csv("D:\\New folder (5)\\infosys\\AI_TransferIQ\\data\\transferiq_dataset_sentiment.csv", index=False)
    print("Sentiment analysis complete. Saved to transferiq_dataset_sentiment   .csv")
